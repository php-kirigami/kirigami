...
| `@kirigami/php-wasm` | 8.5.10-5 | Custom PHP 8.5.10 WASM build, JSPI + Node only, fork of WordPress Playground; includes Imagick. Version encodes the bundled PHP build (`8.5.10-5` → PHP 8.5.10, build 5). |
